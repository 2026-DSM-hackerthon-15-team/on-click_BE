...
public enum ErrorCode {
    ...
    POS_DATA_NOT_FOUND(HttpStatus.NOT_FOUND, "예측에 사용할 POS 판매 데이터가 없습니다."),
    ...
    INVALID_INSTAGRAM_POST(HttpStatus.BAD_REQUEST, "Instagram 게시 요청이 올바르지 않습니다."),
    DUPLICATE_PUBLISH_REQUEST(HttpStatus.CONFLICT, "이미 처리된 Instagram 게시 요청입니다."),
    INSTAGRAM_CREDENTIALS_INVALID(HttpStatus.UNPROCESSABLE_ENTITY, "Instagram 로그인 정보가 올바르지 않습니다."),
    INSTAGRAM_LOGIN_CHALLENGE_REQUIRED(HttpStatus.UNPROCESSABLE_ENTITY, "Instagram 추가 인증이 필요합니다."),
    BROWSER_MCP_UNAVAILABLE(HttpStatus.BAD_GATEWAY, "Instagram 게시 자동화를 사용할 수 없습니다."),
    INSTAGRAM_PUBLISH_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT, "Instagram 게시 처리 시간이 초과되었습니다."),
